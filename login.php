...
<body>
    <div class="auth-container">
        ...
        <div class="auth-banner">
            ...
            <p class="auth-banner-subtitle">Simplify your workflow and boost productivity with our powerful task management system</p>
        ...
        <div class="auth-form">
            ...
            if(isset($_SESSION['login_error'])) {
                echo '<div class="error-message"><i class="fas fa-exclamation-circle"></i>' . $_SESSION['login_error'] . '</div>';
